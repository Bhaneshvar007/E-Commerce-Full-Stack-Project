...
export default function TrustBar() {
  return (
    <section className="bg-[var(--secondary)]/50 border-t border-b border-[var(--border)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="flex items-start gap-4 text-center md:text-left">
            <Truck className="w-6 h-6 text-purple-700 flex-shrink-0 mt-0.5" />
            <div>
          ...
          <div className="flex items-start gap-4 text-center md:text-left">
            <RotateCcw className="w-6 h-6 text-purple-700 flex-shrink-0 mt-0.5" />
            <div>
              <p className="font-semibold text-[var(--foreground)]">Easy Returns</p>
